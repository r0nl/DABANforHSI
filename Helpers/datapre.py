...
def load_data03(image_file, label_file):
    # Open the image file with h5py
    with h5py.File(image_file, 'r') as image_data:
        # Assuming 'ori_data' is the name of the dataset in the HDF5 file
        data_all = image_data['ori_data'][:]

    # Open the label file with h5py
    with h5py.File(label_file, 'r') as label_data:
        # Assuming 'map' is the name of the dataset in the HDF5 file
